...
//  Road to 1M
//
//  Created by David Seymour on 29/7/18.
...
// Add Side-Bar which shows who is online
// Make the Messages View Controller "Prettier"
/////////////////////////////////////////////////////////
class ChatPageViewController: JSQMessagesViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        // NEED TO CODE FACEBOOK USER ID's HERE
    ...
    @objc func showDisplayNameDialog()
    {
        ...
        alert.addTextField { textField in
            ...
            {
                let names = ["David", "Arthur", "Bradley", "Natasha", "Rhen", "Sylvia", "Raymond"]
